...
| [`MiniMaxAI/MiniMax-H3-A100-40GB.md`](./MiniMaxAI/MiniMax-H3-A100-40GB.md) | MiniMax H3 FL2VA and Ref2VA on A100-40GB | 4x A100-SXM4-40GB (TP4 + CPU offload or rank-local DLO) |
